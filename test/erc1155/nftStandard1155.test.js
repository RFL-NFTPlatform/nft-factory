...
const NFTContract = artifacts.require("RFOXNFTStandard1155");

const wei = web3.utils.toWei;
const provider = waffle.provider;

describe("Miss PH NFTStandard1155", function () {
  console.log("Starting NFTStandard1155...");
  ...
  beforeEach(async () => {
    ...
    nftContract = await ethers.getContractFactory("RFOXNFTStandard1155");
