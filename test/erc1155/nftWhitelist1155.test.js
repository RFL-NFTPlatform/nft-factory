...
const NFTContract = artifacts.require("RFOXNFTWhitelist1155");
...
describe("Miss PH NFTWhitelist1155", function () {
  console.log("Starting NFTWhitelist1155...");
  ...
  beforeEach(async () => {
    ...
    nftContract = await ethers.getContractFactory("RFOXNFTWhitelist1155");
  ...
  it("Update base URI", async function () {
    ...
    await missAny.buyNFTsPublic(10, id1);
  ...
  it("Can't mint for non active token", async function () {
    ...
    await expectRevert(missAny.buyNFTsPublic(10, nonActiveTokenID), "Token is not active");
  ...
  it("Can't mint NFTs if has not enough token approval", async function () {
    await expectRevert(missAny.buyNFTsPublic(10, id1), "ERC20: insufficient allowance");
  ...
  it("Mint NFTs should failed if exceed the total limit per one tx", async function () {
    ...
    await expectRevert(missAny.buyNFTsPublic(20, id1), "Max purchase per one transaction exceeded");
  });
  ...
  it("Mint NFTs should failed if has not been started", async function () {
    ...
    await expectRevert(missAnyWithETH.buyNFTsPublic(10, id1), "Sale has not been started");
  });
  ...
  it("Mint NFTs should failed if sale has been finished", async function () {
    ...
    await expectRevert(missAnyWithETH.buyNFTsPublic(10, id1), "Sale has been finished");
  });
  ...
  it("Cannot mint exceed max NFTs case 1", async function () {
    ...
    await expect(missAny.buyNFTsPublic(1, id1)).to.be.revertedWith(
      "Exceeded Max NFTs"
    );
  });
  ...
  it("Cannot mint exceed max NFTs case 2", async function () {
    ...
    await missAny.buyNFTsPublic(10, id1);
    await missAny.buyNFTsPublic(5, id1);
    await expect(missAny.buyNFTsPublic(10, id1)).to.be.revertedWith(
      "Exceeded Max NFTs"
    );
  });
  ...
  it("Purchasing with ETH should failed if ETH is invalid", async function() {
    ...
    await expectRevert(missAnyWithETH.buyNFTsPublic(10, id1, {value: wei("11", "wei")}), "Invalid eth for purchasing");
    await expectRevert(missAnyWithETH.buyNFTsPublic(10, id1, {value: wei("9", "wei")}), "Invalid eth for purchasing");
  })
  ...
  it("Purchasing NFT with eth", async function() {
    ...
    await missAnyWithETH.buyNFTsPublic(10, id1, {value: wei("10", "wei")});
  ...
  it("Purchasing NFT with eth should be failed if sale token is set", async function() {
    ...
    await expectRevert(missAnyWithETH.buyNFTsPublic(10, id1, {value: wei("10", "wei")}), "ETH_NOT_ALLOWED");
  })
  ...
  it("Withdraw eth", async function() {
    ...
    await missAnyWithETH.connect(sara).buyNFTsPublic(10, id1, {value: wei("10", "ether")});
  ...
  it("Minting public from contract should fail", async function() {
    ...
    await expectRevert(mockContractBuyer.mockBuyNFTSPublic(1, id1), "Caller must be EOA");
  })
  ...
  it("Unwhitelist Can't mint NFTs from the presale", async function () {
    ...
    await expectRevert(missAny.buyNFTsPresale(10, id1, []), "Unauthorized to join the presale");
  });
  ...
  it("Whitelisted address Can mint NFTs before public start sale started and after presale started", async function () {
    ...
    await missAny2.connect(bob).buyNFTsPresale(5, id1, []);
    expect(await missAny2.balanceOf(bob.address, id1)).to.be.equal(5);
    await expectRevert(missAny2.buyNFTsPresale(10, id1, []), "Unauthorized to join the presale");

    // Should revert if mint the presale exceed the limit
    await expectRevert(missAny2.connect(bob).buyNFTsPresale(1, id1, []), "Exceed the limit");
  });
  ...
  it("Whitelisted address Can't mint NFTs if the quota for presale is full", async function () {
    ...
    await missAny2.connect(bob).buyNFTsPresale(10, id1, bobProof);
    expect(await missAny2.balanceOf(bob.address, id1)).to.be.equal(10);

    // Should revert if mint the presale exceed the limit
    await expectRevert(missAny2.connect(sara).buyNFTsPresale(1, id1, saraProof), "Exceeded Max NFTs");
  });
  ...
  it("Minting public or presale from contract should fail", async function() {
    ...
    mockContractBuyer = await MockContractBuyer.deploy(missAny.address);
    await mockContractBuyer.deployed();
    await expectRevert(mockContractBuyer.mockBuyNFTSPresale(1, id1), "Caller must be EOA");
    await expectRevert(mockContractBuyer.mockBuyNFTSPublic(1, id1), "Caller must be EOA");
  })
  ...
  it("Whitelisted minting must use the presale price (using eth)", async function () {
    ...
    await missAnyWithETH.connect(bob).buyNFTsPresale(5, id1, [], {value: presalePayment});
    expect(await missAnyWithETH.balanceOf(bob.address, id1)).to.be.equal(5);
    await expectRevert(missAnyWithETH.buyNFTsPresale(10, id1, [], {value: presalePayment}), "Unauthorized to join the presale");

    // Should revert if mint the presale exceed the limit
    await expectRevert(missAnyWithETH.connect(bob).buyNFTsPresale(1, id1, [], {value: presalePayment}), "Exceed the limit");
  ...
  it("Mint NFTs presale should failed if sale has been finished", async function () {
    ...
    await expectRevert(missAnyWithETH.connect(bob).buyNFTsPresale(5, id1, []), "Sale has been finished");
  });
  ...
  it("Mint NFTs presale should failed if invalid eth sent", async function () {
    ...
    await expectRevert(missAnyWithETH.connect(bob).buyNFTsPresale(5, id1, []), "Invalid eth for purchasing");
  });
  ...
  it("Purchasing NFT presale with eth (without sale end time)", async function () {
    ...
    await missAnyWithETH.connect(bob).buyNFTsPresale(5, id1, [], {value: wei("5", "ether")});
  });
  ...
  it("Whitelisted minting failed if payment required token but eth being sent", async function () {
    ...
    await expectRevert(missAny2.connect(bob).buyNFTsPresale(5, id1, [], {value: "1"}), "ETH_NOT_ALLOWED");
  });
  ...
  it("Whitelisted address Can mint NFTs after public start sale started", async function () {
    ...
    await expectRevert(missAny2.connect(bob).buyNFTsPublic(10, id1), "Sale has not been started");

    await ethers.provider.send("evm_mine", [saleStartTime+4000]);

    await missAny2.connect(bob).buyNFTsPublic(10, id1);
    expect(await missAny2.balanceOf(bob.address, id1)).to.be.equal(10);
  });
